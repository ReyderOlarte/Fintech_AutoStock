...
public class CandleStickSample {
	...
	public static JFreeChart buildChart() {
		...
		// Build Bar Chart for volume by wrapping price dataset with an
		// IntervalXYDataset
		IntervalXYDataset volumeDataset = getVolumeDataset(priceDataset, 24 * 60 * 60 * 1000); // Each
																								// bar
																								// is
																								// 24
																								// hours
